    ...
    <view class="main">
        <scroll-view scroll-y="true" class="scroll">
            ...
            <view class="comment-main">
                ...
                <!--   评论-->
                <view class="content">
                    <view class="content-item" v-for="item in commentList">
                        <view class="left">
                        ...
                        <view class="right">
                            <view class="content-title">
                                <view class="content-title-detail">
                                    ...
                                    <view class="tag" v-if="item.uid===dynamic.userId">楼主</view>
                                </view>
                                <view class="time">
                            ...
                            <view class="text">
                                <view class="article" @tap="doComment(item)">
                                    {{ item.content }}
                                </view>
                            </view>
                            ...
                            <!--  回复-->
                            <view class="recoment">
                                <view class="recomment-item" v-for="reItem in item.recomment">
                                    <view class="recomment-left">
                                        <image class="recomment-headImg" :src="reItem.headImgUrl" :draggable="false"
                                               mode="widthFix" @tap="userDetail(reItem.uid)" />
                                    </view>
                                    <view class="recomment-right">
                                        <view class="recomment-title">
                                            <view class="recomment-title-bar">
                                                <view class="recomment-username">
                                                    <uni-section titleColor="#4d86e9" :title="reItem.nickName"
                                                                 titleFontSize="18px" @tap="userDetail(reItem.uid)"/>
                                                </view>
                                                <view class="recomment-tag" v-if="reItem.uid===dynamic.userId">楼主
                                                </view>
                                                <view class="recomment-to" v-if="reItem.toUid">
                                                    <u-icon mr-0.5 name="play-right-fill" />
                                                    <view class="recomment-username">
                                                        <uni-section titleColor="#4d86e9" :title="reItem.nickName"
                                                                     titleFontSize="18px" @tap="userDetail(reItem.toUid)"/>
                                                    </view>
                                                    <view class="recomment-tag" v-if="reItem.uid===dynamic.userId">
                                                        楼主
                                                    </view>
                                                </view>
                                            </view>
                                        ...
                                        <view class="recomment-text" @tap="doComment(reItem)">
                                            {{ reItem.content }}
                                        </view>
        ...
        <view class="bottomBar">
            ...
            <view class="comment-area">
                <view class="textarea">
                    <textarea placeholder="评论" v-model="commentContent" maxlength="-1" auto-height />
                </view>
            ...
            <view  class="sendImgs">
                <uni-file-picker v-model="imgList" fileMediatype="image"
...
export default {
    components: { UniFilePicker, UniDataPicker, UIcon, UAlbum, UniSection, UAvatar, Dynamic },
    data() {
        return {
            dynamic: "",
            commentNum: 0,
